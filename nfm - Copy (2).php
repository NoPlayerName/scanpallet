...
<div class="container">
 ...
 <input type="text" name="refrak" id="refrak" style="font-size:15pt;height:35px;width:100%" tabIndex="3" value="" autocomplete="off">
 <input type="text" name="tbl" id="tbl" style="font-size:15pt;height:35px;width:100%" tabIndex="3" value="" autocomplete="off">
 
 <button type="button" name="button1" class="btn btn-primary btn-xs button button1" id="button1" style='display:yes'>Part No</button>
 <button type="button" name="button2" class="btn btn-primary btn-xs button button2" id="button2" style='display:yes'>No Pallet</button>
 <button type="button" name="button3" class="btn btn-primary btn-xs button button3" id="button3" style='display:yes'>Save</button>
...
<div class="modal fade container vertical-alignment-helper" id="modalitem" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	...
	<br><br><br><br><br>
		<div class="modal-content">
			...
			<div class="modal-body" id="datarak" style='font-size:20px' align='center' style='font-coloe'>
			</div>
