...
<div class="container">
	...
	<label style="font-size:20pt">Form Cut Off</label>
	</legend>
</div>
<form id='myform'>
<div class="container">
...
$(document).on('click', '.button2', function () {
	...
	var nopallco2 = document.getElementById('nopall').value;
	var norakco = document.getElementById('norak').value;
			
		$.ajax({
			url: 'ajax/view.php',	
			method: 'post',		
			data: {norakco:norakco,nopallco2:nopallco2},		
			success:function(data){		
			$('#h2').html(data);
			}
		});
