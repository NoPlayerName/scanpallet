...
$serverName = "SRV02\TIMEPRO";
$connectionInfo = array( "Database"=>"fg", "UID"=>"sa", "PWD"=>"timepro");
$conn = sqlsrv_connect( $serverName, $connectionInfo );

/* $mysqlservername = "10.63.96.24";
$mysqlusername = "fg";
$mysqlpassword = "figood";
$mysqldbname = "palletdb";
$mysqlconn = new mysqli($mysqlservername, $mysqlusername, $mysqlpassword, $mysqldbname);
//$partno =htmlspecialchars($_POST["partno"]);
...
$sql2 = "SELECT tblmasuk.partno,tblmasuk.partname, tblproduk.kodeproduk
                                FROM tblmasuk
                                INNER JOIN tblproduk ON tblmasuk.partno = tblproduk.partno
								where tblmasuk.partno = '$partno2'
...
$sqla = "select idpallet from tblmasuk where idpallet='$_POST[nopall]' and mark='o'";
...
//echo "<br />";
   ...
   $_POST['partno'] = "";
	...
	$_POST['partno'] = "";
	 ...
	 try{
	$querya="INSERT INTO tblmasuk (partno,partname,qty,idpallet,createdatetime,mark) VALUES('$partno2','$partname2','$snp2','$_POST[nopall]',getdate(),'o')";
	$stmta = sqlsrv_query( $conn, $querya);  
	$queryb="INSERT INTO tblmasuk (partno,partname,qty,idpallet,createdatetime,mark) VALUES('MC075509','DIFF CASE RH','30','$_POST[nopall]',getdate(),'o')";
	$stmtb = sqlsrv_query( $conn, $queryb);
	$queryc="insert into transaksi (tglmasuk,idpallet,produkmasuk, masuk, balance) values (getdate(),'$_POST[nopall]','$kop','$snp2',1)";
	$stmtc = sqlsrv_query( $conn, $queryc);
	$queryd="insert into transaksi (tglmasuk,idpallet,produkmasuk, masuk, balance) values (getdate(),'$_POST[nopall]','DIFF CASE M002','30',1)";
	$stmtd = sqlsrv_query( $conn, $queryd);
  ...
  echo $e;
	 ...
	 try{
	$query="INSERT INTO tblmasuk (partno,partname,qty,idpallet,createdatetime,mark) VALUES('$partno2','$partname2','$snp2','$_POST[nopall]',getdate(),'o')";
	$stmt = sqlsrv_query( $conn, $query); 
	$query1="insert into transaksi (tglmasuk,idpallet,produkmasuk, masuk, balance) values (getdate(),'$_POST[nopall]','$kop','$snp2',1)";
  ...
  echo $e;
	 ...
	 try{
	$query="If Not Exists(select * from tblmasuk where idpallet='$_POST[nopall]' and mark = 'o')
			Begin
